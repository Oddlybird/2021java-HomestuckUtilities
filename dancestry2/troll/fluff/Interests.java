...
public class Interests {
	...
	String[] manipulation = {"games", "videogames", "sports", "gambling", "frivolity", "exercise",
			"stage magic", "strategy", "war", "card games", "board games"};
	...
	String[] exploitation = {"stuff, I guess?", "like, things", "yknow like whatever"};
	
	String[] nature = {"nature", "animals", "plants", "fungi", "life", "bugs", "fish", "birds"};
	
	String[] destruction = {"war", "death", "chaos", "apocalypses", "physicality"};
