...
public class Body {
	...
	// -------: FF(fur), FC(Scale), FB(Feathers), CC(keratin/carapace/shell), CB(callous/skin plates), BB(bare)
        // :: add tooth / jaw / mouth mutations, tusks, crazy fangs, etc
	...
	// 2char: BB : cheekfin bioluminescence, BB voluntary, Bb bloodflow, bB constant, bb none.
        ...
        // 2char: mucous membranes / lips / accent color : bloodtone vs above options.  humans bloodtone as accent color, trolls black as accent color.
	...
	// -------: FF(fur), FC(Scale), FB(Feathers), CC(keratin/carapace/shell), CB(callous/skin plates), BB(bare)
		...
		if (blood=="truerand") {
			...
			return var;};
		// caste presets
	if (blood.startsWith("RR")) {var="ffPPBBBBpp11BB";}; //Maroon
	if (blood.startsWith("Rr")) {var="fFPPBBBBpp11BB";};
	if (blood.startsWith("rr")) {var="ffPPBBBBpp22BB";}; // Bronze
	if (blood.startsWith("Rg")) {var="fFPPBBBBpp22BB";};
	if (blood.startsWith("RG")) {var="ffPPBBBBpp33BB";}; // Gold
	if (blood.startsWith("Gr")) {var="ffPPBBBBpp33BB";};
	if (blood.startsWith("rg")) {var="ffPPBBBBpp33BB";}; // Lime
	if (blood.startsWith("GG")) {var="ffPPBBBBPp35BB";}; // Olive
	if (blood.startsWith("Gg")) {var="ffPPBBBBpP53BB";};
	if (blood.startsWith("gg")) {var="ffPPBBBBpp44BB";}; // Jade
	if (blood.startsWith("Gb")) {var="ffPPBBBBpp33BB";};
	if (blood.startsWith("GB")) {var="ffPPBBBBpp33BB";}; // Teal
	if (blood.startsWith("Bg")) {var="ffPPBBBBpp33BB";};
	if (blood.startsWith("gb")) {var="ffPPBBBBpp33BB";}; // Ceru
	if (blood.startsWith("BB")) {var="ffPPBBBBpp33BB";}; // Bloo
	if (blood.startsWith("Bb")) {var="ffPPBBBBpP33BF";};
	if (blood.startsWith("bb")) {var="ffPPBBBBPp44BB";}; //Indigo
	if (blood.startsWith("Br")) {var="FfPPBBBBpP65FF";};
	if (blood.startsWith("RB")) {var="ffPPBBBBpp44BB";}; //Violet
	if (blood.startsWith("Rb")) {var="fFPPBBBfpp56BB";};
	if (blood.startsWith("rb")) {var="ffPPBBBBpp44BB";}; //Tyrian

	// other presets
	if (blood.startsWith("feral1")) {var="FFDDBBAAPP88FB";};
	if (blood.startsWith("feral2")) {var="FFdDBBSSpP77FC";};
	if (blood.startsWith("feral3")) {var="FFDdBBBBPp66CF";};
	if (blood.startsWith("feral3")) {var="FFDDQqFFPp99CB";};
	if (blood.startsWith("feral4")) {var="FFDDqQDDpP77BC";};
	if (blood.startsWith("feral5")) {var="FFDDQQEEPP55FF";};
	if (blood.startsWith("feral6")) {var="ffppbbTTpp33ff";};
	if (blood.startsWith("feral7")) {var="ffppbbBFpp33bb";};
	if (blood.startsWith("feral8")) {var="ffppbbFBpp33cc";};
	if (blood.startsWith("feral9")) {var="ffppbbEBpp33BB";};
	if (blood.startsWith("feral0")) {var="ffppbbBEpp33CC";};
